...
namespace WindowsFormsApp1
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            b2 = new Bitmap((string)Environment.CurrentDirectory + "\\image.jpg");

            picturePlacement.Image = b;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < b.Width; i++)
            {
                for (int j = 0; j < b.Height; j++)
                {
                    ...
                    else if(Q1 != 0 && Q2 != 0 & Q2 != Q1) red = (byte)(255*(red - Q1)/(Q2-Q1));
                    else red = (byte)(255 * (red - Q1) / (Q2 - Q1 + 1));

                    if (green < Q1) green = 0;
                    else if (green > Q2) green = 255;
                    else if (Q1 != 0 && Q2 != 0 & Q2 != Q1) green = (byte)(255 * (green - Q1) / (Q2 - Q1));
                    else green = (byte)(255 * (green - Q1) / (Q2 - Q1 + 1));

                    if (blue < Q1) blue = 0;
                    else if (blue > Q2) blue = 255;
                    else if (Q1 != 0 && Q2 != 0 && Q2 != Q1) blue = (byte)(255 * (blue - Q1) / (Q2 - Q1));
                    else blue = (byte)(255 * (blue - Q1) / (Q2 - Q1 + 1));
